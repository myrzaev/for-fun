...
export const StyledTabButton = styled.button<IStyledTabButtonProps>`
...
export const StyledHighlight = styled.div<IStyledHighlightProps>`
	position: absolute;
	top: 0;
	left: 0;
	z-index: 10;
...
export const StyledTabPanel = styled.div<IStyledTabPanelProps>`
	width: 100%;
	height: auto;
	padding: 10px 5px;
